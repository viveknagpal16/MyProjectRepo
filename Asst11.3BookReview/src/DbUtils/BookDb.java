...
public class BookDb {
	...
	public static String addBookDetail(String Title,String AuthorName,String Publications,String Edition,String Genre,int No_of_Pages,int Price) throws ClassNotFoundException, SQLException {
	 ...
	 * 
	 */
	public static String removeBook(String title,String Edition) throws ClassNotFoundException, SQLException {
		 cc= MyConnector.conn();
	 ...
	 */
	public static String updateBookEdition(String title,String NewEdition) throws SQLException, ClassNotFoundException {
	...
	public static String updateBookPrice(String title,int NewPrice) throws SQLException, ClassNotFoundException {
